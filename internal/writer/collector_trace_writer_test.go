...
func assertCollectorPayloads(assert *assert.Assertions, traceWriter *CollectorTraceWriter, expectedTraces []agent.Trace, payloads []*payload) {
	expectedTraceIdx := 0
...
func testCollectorTraceWriter() (*CollectorTraceWriter, chan *agent.Trace, *testEndpoint) {
