...
func assertMetadata(assert *assert.Assertions, expectedHeaders map[string]string,
	expectedMetadata agent.ServicesMetadata, payload Payload) {
...
func testServiceWriter() (*ServiceWriter, chan agent.ServicesMetadata, *TestEndpoint, *statsd.TestStatsClient) {
